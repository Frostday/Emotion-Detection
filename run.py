...
# model = tf.keras.models.load_model('models/saved_models_resnet/model100x100.hdf5')
# model = tf.keras.models.load_model('models/saved_models_vgg/model100x100.hdf5')
model = tf.keras.models.load_model('models/saved_models_custom/model100x100.hdf5')
